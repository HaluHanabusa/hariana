...
AGENTS.md を読まない旧バージョンでも、init が生成した
`.cursor/rules/hariana.mdc` が入口になります。
...
|---|---|---|
| 実行手順の読み込み | init が生成する CLAUDE.md 経由で AGENTS.md | AGENTS.md を直接(旧Cursorは生成された .cursor/rules、その他は手動指示) |
